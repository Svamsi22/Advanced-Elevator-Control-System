...
public class Elevator {
    ...
    //  to implement the processFloor(),
    // callElevator() and moveElevator() functions We also have a main function that provides an easy way to manually test your elevator implementation.
